...
export default class Instructors extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:4000/node/user/instructors')
            .then(response => {
                                ...
                                <div className="col-lg-12">
                                    <div className="p-5">
                                        <div className="text-center">
                                            <h1 className="h4 text-gray-900 mb-4 text-primary ">Instructors List</h1>
                                        </div>
                                        <table className="table table-striped" style={{ marginTop: 20 }}>
                                            ...
                                            <tbody>
                                                ...
                                                {
                                                    this.state.instructors.map((currentCourse, i) => (
                                                        <Course  id={currentCourse._id} key={i} username={currentCourse.username} email={currentCourse.email} />
                                                    ))
                                                }
