...
const AssignmentRoutes = require('./api/routes/assignment.routes');
const SubmissionRoutes = require('./api/routes/submission.assignment.routes');
...
app.use('/node/assignment', AssignmentRoutes);
app.use('/node/submission', SubmissionRoutes);
app.use('/node/exam', ExamRoutes);
