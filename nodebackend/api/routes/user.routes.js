          ...
          user.save().then(result => {
            ...
            if (result.type === 'instructor') {
              ...
              let mailOptions = {
                ...
                to: result.email,
                subject: 'Your ABC Institute Account  Has Been Activated !!!',
                text: "Dear Instructor, Your ABC Institute Account Has Been Activated. Your Login Credentials Are, Username : " +req.body.username +"  , "+"Password : "+ req.body.password+ " . Thank You for connecting with us.HAVE A GOOD DAY !",
